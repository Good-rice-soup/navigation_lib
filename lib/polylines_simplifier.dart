...
class PolylineSimplifier {
  ...
  void get rmsStates {
    print('---///--- orig route RM current segment ind - ${originalRouteRouteManager.currentSegmentIndex}');
    print('---///--- shifted route RM current segment ind - ${shiftedRouteRouteManager.currentSegmentIndex}');
